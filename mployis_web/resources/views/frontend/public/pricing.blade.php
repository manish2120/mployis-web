                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-7 text-center">
                                                        ...
                                                        <div class="text-center">
                                                            <span class="mb-2 text-primary">&#8377</span>
                                                    ...
                                                    <div class="w-100 mb-10">
                                                        ...
                                                        <div class="d-flex flex-stack mb-5">
                                                            <span
                                                                class="fw-bold fs-6 text-gray-800 text-start pe-3">Verified
                                                                Blue Tick</span>
                                                        ...
                                                        <div class="d-flex flex-stack mb-5">
                                                            <span
                                                                class="fw-bold fs-6 text-gray-800 text-start pe-3">Resume
                                                                Boost</span>
                                                            <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                                            <span class="svg-icon svg-icon-1 svg-icon-success">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        ...
                                                        <!--begin::Item-->
                                                        <div class="d-flex flex-stack mb-5">
                                                            <span class="fw-bold fs-6 text-gray-800">checks the profile
                                            ...
                                            <div class="d-flex h-100 align-items-center">
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-7 text-center">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                        <div class="text-gray-400 fw-bold mb-5">Best features for
                                                            premium user</div>
                                                        <!--end::Description-->
                                                        <!--begin::Price-->
                                                        <div class="text-center">
                                                            <span class="mb-2 text-primary">&#8377
                                                            </span>
                                                            <span class="fs-3x fw-bolder text-primary"
                                                                data-kt-plan-price-month="999"
                                                                data-kt-plan-price-annual="1999">999</span>
                                                            <span class="fs-7 fw-bold opacity-50"
                                                                data-kt-plan-price-month="Mon"
                                                                data-kt-plan-price-annual="Ann">/ 1999</span>
                                                        </div>
                                                        <!--end::Price-->
                                                    </div>
                                                    <!--end::Heading-->
                                                    ...
                                                    <div class="w-100 mb-10">
                                                        ...
                                                        <div class="d-flex flex-stack mb-5">
                                                            <span
                                                                class="fw-bold fs-6 text-gray-800 text-start pe-3">verification</span>
                                                            <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                                            <span class="svg-icon svg-icon-1 svg-icon-success">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24"
