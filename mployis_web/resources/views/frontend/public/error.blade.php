...
<section class="relative z-10 bg-primary h-100" style="
display: flex;
align-items: center;">
        ...
        <div class="w-full px-4">
           <div class="mx-auto max-w-[400px] text-center">
              ...
              <a
                 ...
                 class="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:color[#009EF7]"
                 >
              Go To Home
              </a>
           </div>
