        ...
        <div class="mb-0" id="home">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <!-- Container for detailed job data -->
                    <div class="company_list row mt-4"></div>  --}}

                    <!-- Start Looping through companies -->
                    <h1 class="leading-[50px]">Companies</h1>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="company-card">
                            <div class="logo-container d-flex align-items-center" style="width: 70px; height: 70px; overflow: hidden; border-radius: 70%; margin-right: 8px;">
                                @if($company->logo) <!-- Check if the logo exists -->
                                    <img src="{{ asset($company->logo) }}" alt="Logo" class="company-logo" style="width: 70px; height: 70px;">
                                @else
                                    <img src="{{ asset('frontend/assets/media/avatars/blank.png') }}" alt="Logo">
                                @endif
                            </div>
                            <h2 class="text-dark fw-bolder mb-5 mt-5">{{ $company->company_name ?? '' }}</h2>
                            
                            <div class="mt-3">
                                <div class="fs-5 text-muted fw-bold"><i class="fa fa-map-marker-alt text-gray-800"></i> 
                                    {{ $countryData->country_name ?? '' }}
                                </div>
                            </div>
                            <a href="#" target="_blank" class="btn btn-primary mt-3">View Details</a>
                        </div>
                    </div>
                    @endforeach
                    <!-- End Loop -->
                        ...
                        success: function(data) {
                            ...
                            if(data.suggestions.length > 0) {
                                data.suggestions.forEach(company => {
                                    suggestions += `
                                      <div class="suggestion-item" style="cursor: pointer;" data-title="${company}">
                                            ${company}
                                        </div>`;
                                });
                            } else {
