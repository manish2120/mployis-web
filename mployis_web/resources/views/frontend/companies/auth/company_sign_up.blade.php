  ...
  <div class="d-flex flex-column flex-root">
      ...
      <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
          ...
          <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
              ...
              <!--begin::Wrapper-->
              @if (session('status'))
                  <div class="alert {{ session('alert_class') }} fw-bold fs-5">
                      {{ session('status') }}
                  </div>
              @endif
              <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                  <!--begin::Form-->
                  <form class="form w-100" novalidate="novalidate" id="registrationForm">
                      @csrf
                      <!--begin::Heading-->
                      <div class="mb-10 text-center">
                          <!--begin::Title-->
                          <h1 class="text-dark mb-3">Create a Company Account</h1>
                          <!--end::Title-->
                          <!--begin::Link-->
                          <div class="text-gray-400 fw-bold fs-4">Already have an account?
                              <a href="{{ route('account.company.sign-in') }}" class="link-primary fw-bolder">Sign in here</a>
                          </div>
                          <!--end::Link-->
                      </div>
                      <!--end::Heading-->
        ...
        <img alt="Logo" src="{{url('frontend/assets/media/svg/brand-logos/google-icon.svg')}}" class="h-20px me-3" />Sign in with Google</button> --}}
                        ...
                        <input type="hidden" name="role" value="company">
                          ...
                          <div class="col-xl-6">
                              ...
                              <input class="form-control form-control-lg form-control-solid" type="text"
                                  placeholder="" name="name" id="name" value="" autocomplete="off" />
                          ...
                          <div class="col-xl-6">
                              ...
                              <input class="form-control form-control-lg form-control-solid" type="text"
                                  placeholder="" name="phone_no" id="phone_no" value="" autocomplete="off" />
                                  <div class="invalid-feedback"></div>
                      ...
                      <div class="fv-row mb-5">
                          ...
                          <input class="form-control form-control-lg form-control-solid" type="password"
                              placeholder="" name="cpassword" id="cpassword" value="" autocomplete="off" />
                              <div class="invalid-feedback"></div>
                      ...
                      <div class="text-center mt-5">
                          <span class="text-gray-400 fw-bold">Already Register? Login (<a
                                  href="{{ route('account.candidate-sign-in') }}">Student</a> / <a
                                  href="">Company</a>)</span>
                      </div>
                  </form>
                  <!--end::Form-->
...
<script>
  $(document).ready(function() {
     ...
     const inputs = ['name', 'phone_no', 'email']
    ...
    $('#registrationForm').on('submit', function(event) {
      ...
      let messageTimeout;
      $.ajax({
        url: "{{ route('account.company.company-sign-up') }}",
        type: 'POST',
        headers: {
