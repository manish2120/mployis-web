        ...
        <div class="container">
            ...
            <div class="row py-10 py-lg-20">
                ...
                <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                    <!--begin::Block-->
                    <div class="rounded  p-9 mb-10"><!--landing-dark-border-->
                        <img alt="Logo" src="{{ asset('frontend/assets/media/logos/Mployis.png') }}" class="logo-default h-25px h-lg-95px" />
                    </div>
                    <!--end::Block-->
                    <!--begin::Block-->
                    <div class="rounded  p-3"><!--landing-dark-border-->
                        <div class="fs-5 text-muted fw-bold">At Mployis, we believe that every step toward your dream job is a step toward a brighter future. We're here to support you, whether you're a job seeker or an employer, as you build a successful career or team. Together, we can achieve great things. Let's grow, connect, and succeed—one opportunity at a time.</div>
                    </div>
                    <!--end::Block-->
                </div>
                <!--end::Col-->
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    <!--begin::Logo-->
                    <a href="{{ route('home') }}">
                        <img alt="Logo" src="{{ asset('frontend/assets/media/logos/Mployis.png') }}" class="h-15px h-md-20px" />
                    </a>
                    <!--end::Logo image-->
                    <!--begin::Logo image-->
                    <span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="https://keenthemes.com">© 2024 MPLOYIS</span>
                    <!--end::Logo image-->
                </div>
                <!--end::Copyright-->
                <!--begin::Menu-->
                <ul class="menu menu-gray-600 menu-hover-primary fw-bold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
                    ...
                    <li class="menu-item">
                        <a href="{{ url('/contact') }}" target="_blank" class="menu-link px-2">Contact</a>
                    </li>
                </ul>
                <!--end::Menu-->
            </div>
